...
export default function CommonInvoiceDetailPage() {
  return (
    <PrivateRoute>
      <CommonInvoiceDetailContent />
    </PrivateRoute>
  );
}

function CommonInvoiceDetailContent() {
        ...
        <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-3xl border border-rose-100 dark:border-rose-950 shadow-xl max-w-md w-full text-center space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              You do not have permission to view this invoice. Reseller/Customer invoices are strictly restricted to their original owners.
            </p>
          </div>
  ...
  return (
    <div className="py-8 px-4 bg-slate-50/50 dark:bg-slate-950 min-h-screen">
      <SharedInvoiceRenderer invoiceData={invoiceData} backUrl="/invoice/my-invoices" />
    </div>
  );
}
